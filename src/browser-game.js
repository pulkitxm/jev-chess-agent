...
export async function startEngine(page, signal, opponent = 'maximum') {
  ...
  while (Date.now() < deadline) {
    ...
    if (await page.getByText('Performing security verification', { exact: true }).isVisible()) throw new Error('Chess.com requires human verification. The game has not started.');
